...
<html>
  ...
  <body>
  	<div class = "container-fluid">
        <ul class="nav bg-warning fixed-top">
          <a class = "navbar-brand" href="{{ url('/') }}"> <img class="m-2"src="images/logo.jpg" alt="logo" width ="30px" height ="30px"></a>
            @auth
                ...
                @endphp
            @else
                <a class ="nav-link text-dark text-sm text-gray-700 dark:text-gray-500 underline" href="{{ route('admin-login') }}">Log-in</a>
            @endif
        </ul>
        ...
        <div class = "row text-center">
            <div class ="col">
  			...
  			<div class ="col-lg-4 col-md-8 col-sm-12 col-xs-12 text-left mt-5">
