...
<body>
    ...
    <div class="container-fluid">
        ...
        <form action="{{route('transaction_report')}}" method="get" enctype="multipart/form-data">
            <div class="row mb-2">
                ...
                <div class="col-lg-2 col-md-4 col-sm-2 col-xs-2 mt-2">
                    <button type="submit" class="btn btn-success btn-sm">Export as PDF</button>
                </div>
            </div>
            {{--  --}}
        </form>
        ...
        <div class="row">
            <div class="col-lg-13 p-3 text-dark m-relative">
                <table id="order_history" class="table table-striped aos-init aos-animate shadow-lg p-2" data-aos="fade-right" data-aos-delay="500" data-aos-duration="700">
                    <thead>
